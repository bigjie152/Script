...
const routeLabel = "POST /api/projects/:id/unpublish";
...
export async function POST(
  ...
  try {
    ...
    return jsonResponse({ published: false }, { requestId });
  } catch (error) {
    ...
    return jsonError(500, "failed to unpublish project", undefined, requestId);
  }
}
